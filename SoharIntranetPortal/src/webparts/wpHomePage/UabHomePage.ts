              ...
              <div
                ...
                <a class="announcement-item">
                  <div class="announcement-icon bg-1">
                    <img src="./resources/images/icons/announcement-1.png" />
                  </div>
                  <div class="flex-grow-1">
                    <p class="announcement-title mb-1">IT System Maintenance</p>
                    <p class="announcement-desc">Scheduled maintenance on May 25, 2024 from 10:00 PM to 2:00 AM.</p>
                  </div>
                  <span class="announcement-date">May 20, 2024</span>
                </a>
                <a class="announcement-item">
                  <div class="announcement-icon bg-2">
                    <img src="./resources/images/icons/announcement-2.png" />
                  </div>
                  <div class="flex-grow-1">
                    <p class="announcement-title mb-1">Policy Update</p>
                    <p class="announcement-desc">New HR policy update effective from June 1, 2024.</p>
                  </div>
                  <span class="announcement-date">May 18, 2024</span>
                </a>
                <a class="announcement-item">
                  <div class="announcement-icon bg-2">
                    <img src="./resources/images/icons/announcement-2.png" />
